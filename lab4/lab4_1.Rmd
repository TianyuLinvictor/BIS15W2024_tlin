...
Load the data.  
```{r}
mammal <- read.csv("~/Desktop/BIS15W2024_tlin/lab3/data/mammal_lifehistories_v2.csv")
```
...
```{r}
mammal_new <- rename(mammal,genus="Genus",wean_mass="wean.mass",max_life="max..life",litter_size="litter.size",litters_year="litters.year") 
```
